                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    <h4 class="font-weight-bolder">Inicia Sesión en TrekCom</h4>
                                    <p class="mb-0">Ingresar E-mail y Password</p>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-1 text-sm mx-auto">
                                        Olvidaste tu Password, Comunicate con el Area Tecnica
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-warning  h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://trekform.com/wp-content/uploads/2017/04/Altura2.jpg');
              background-size: cover;">
                                <span class="mask bg-gradient-warning  opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Gestión Integral de Formación. "</h4>
                                <p class="text-white position-relative">Trekform
                                    </p>
                            </div>
                        </div>
                    </div>
